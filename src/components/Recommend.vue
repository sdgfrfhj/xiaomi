		...
		<div class="recommend-header">
			...
			<div class="control-part">
				...
				<span
					...
					:class="{'disable': this.currPage === Math.ceil((this.recomends.length) / 5)}">
...
export default {
	...
	methods: {
		slideNext () {
			if (this.currPage < Math.ceil((this.recomends.length) / 5)) {
				this.currPage++
				$('.recommend-content').css('margin-left', (this.currPage * (-1226) + 1226) + 'px')
			}
		},
		slidePre () {
			if (this.currPage > 1) {
